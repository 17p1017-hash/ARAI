...
const EVENTS = [
  {title:'魔法の森', desc:'不思議な霧で道が見えません。みんなの道具とアイデアで進む方法を考えよう。'},
  {title:'ドラゴン出現', desc:'大きなドラゴンが道をふさいでいます。戦う以外の方法も自由に考えてOK！'},
  {title:'古代神殿', desc:'古い神殿には謎の扉があります。持っている道具をどう使う？'},
  {title:'魔王城', desc:'いよいよ魔王城。みんなで考えた作戦で最後の冒険に挑もう！'}
];
